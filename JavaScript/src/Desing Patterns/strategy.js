//Allows an algorithm to be selected dynamically during program execution, 
//encapsulating them into independent classes and allowing them to be swapped easily
...
//Without using the design patter you could have done:
fedex.calculate(pkg);